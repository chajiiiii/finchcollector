...
def finches_detail(request, finch_id):
    ...
    toys_finch_deosnt_have = Toy.objects.exclude(id__in=id_list)

    feeding_form = FeedingForm()

    return render(request, "finches/detail.html", { 'finch' : finch, 'feeding_form': feeding_form, 'toys': toys_finch_deosnt_have})
